...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb='\n\x0bguide.proto\x12\x15Sanguo.protocol.guide\"N\n\x0bGuideNotify\x12\x0f\n\x07session\x18\x01 \x02(\x0c\x12.\n\x04step\x18\x02 \x02(\x0e\x32 .Sanguo.protocol.guide.GuideStep\"%\n\x12GuideFinishRequest\x12\x0f\n\x07session\x18\x01 \x02(\x0c\"3\n\x13GuideFinishResponse\x12\x0b\n\x03ret\x18\x01 \x02(\x05\x12\x0f\n\x07session\x18\x02 \x02(\x0c*\xa8\x01\n\tGuideStep\x12\x10\n\x0cGUIDE_FINISH\x10\x00\x12\x0f\n\x0bGUIDE_STORY\x10\x01\x12\x15\n\x11GUIDE_SHOW_BATTLE\x10\x02\x12\x11\n\rGUIDE_GETHERO\x10\x03\x12\x1b\n\x17GUIDE_HERO_IN_FORMATION\x10\x04\x12\x1c\n\x18GUIDE_EQUIP_IN_FORMATION\x10\x05\x12\x13\n\x0fGUIDE_FIRST_PVE\x10\x06')
...
_GUIDESTEP = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='GUIDE_FINISH', index=0, number=0,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_STORY', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_SHOW_BATTLE', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_GETHERO', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_HERO_IN_FORMATION', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_EQUIP_IN_FORMATION', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GUIDE_FIRST_PVE', index=6, number=6,
      options=None,
      type=None),
  ],
...
GUIDE_SHOW_BATTLE = 2
GUIDE_GETHERO = 3
GUIDE_HERO_IN_FORMATION = 4
GUIDE_EQUIP_IN_FORMATION = 5
GUIDE_FIRST_PVE = 6
