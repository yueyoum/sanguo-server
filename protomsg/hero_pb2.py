...
_GETHEROPANELNOTIFY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='free_times', full_name='Sanguo.protocol.hero.GetHeroPanelNotify.free_times', index=1,
      number=2, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='open_sycee', full_name='Sanguo.protocol.hero.GetHeroPanelNotify.open_sycee', index=2,
      number=3, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='refresh_sycee', full_name='Sanguo.protocol.hero.GetHeroPanelNotify.refresh_sycee', index=3,
      number=4, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='sockets', full_name='Sanguo.protocol.hero.GetHeroPanelNotify.sockets', index=4,
...
_HEROSTEPUPRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='Sanguo.protocol.hero.HeroStepUpResponse.id', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='step', full_name='Sanguo.protocol.hero.HeroStepUpResponse.step', index=3,
      number=4, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='max_socket_amount', full_name='Sanguo.protocol.hero.HeroStepUpResponse.max_socket_amount', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_socket_amount', full_name='Sanguo.protocol.hero.HeroStepUpResponse.current_socket_amount', index=5,
