...
_SELLREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='elements', full_name='Sanguo.protocol.world.SellRequest.elements', index=0,
