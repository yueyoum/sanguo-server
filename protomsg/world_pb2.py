...
_FUNCTIONTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FUNC_SOCKET_FIVE', index=14, number=50,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FUNC_SOCKET_SIX', index=15, number=51,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FUNC_SOCKET_SEVEN', index=16, number=52,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FUNC_SOCKET_EIGHT', index=17, number=53,
      options=None,
      type=None),
  ],
